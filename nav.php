    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
        <?php if (@$_SESSION['userID'] == null) {
          ...
          <li class="nav-item">
            <a class="btn" data-container="body" data-toggle="popover" data-placement="bottom" data-html="true" title="LINE Pay儲值" data-content="<div><input id='lineMoney' type='number'></input><button class='btn btn-primary sumbitLine' onclick='callLINEAPI();'>儲值</button></div><div align='center'>需於手機版LINE上確認</div><img src='img/LINEQRCode.png' style='display:block; margin:auto;'></img>">
